...
import 'package:chat_app/create_org_page.dart';
                  ...
                  IconButton(
                      onPressed: () {
                        if (currentUserNotifier()
                          ...
                          currentUserNotifier().currentPage = 'Organisation';
                ...
                child: StreamBuilder<QuerySnapshot<Map<String, dynamic>>>(
                  ...
                  builder: (context, snapshot) {
                    if (snapshot.hasData) {
                      ...
                      final chatList = currentUserNotifier
                          .chatlist; // Get the chatlist of currentUser from provider which is constantly updated when new user added from searchpage
                      return ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          if (chatList!.contains(data['email'])) {
                            return InkWell(
                              onTap: () {
                                Navigator.push(
                                  context,
                              ...
                              child: Padding(
                                ...
                                child: buildChatsList(
                                  data['name'],
                                  data['email'],
                                  'profileimg${generateRandomNumber()}.jpg',
                                ),
                              ),
                            );
                          } else {
