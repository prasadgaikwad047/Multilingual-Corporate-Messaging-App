import 'package:chat_app/group_chat_screen.dart';
import 'package:chat_app/login.dart';
import 'package:chat_app/org_group_create_page.dart';
...
class MyOrganisationGroupPage extends StatefulWidget {
  const MyOrganisationGroupPage({super.key});

  @override
  State<MyOrganisationGroupPage> createState() =>
      _MyOrganisationGroupPageState();
}

class _MyOrganisationGroupPageState extends State<MyOrganisationGroupPage> {
  ...
  void initState() {
    ...
    _dataStream = FirebaseFirestore.instance.collection('groups').snapshots();
  }
                ...
                child: StreamBuilder<QuerySnapshot<Map<String, dynamic>>>(
                  ...
                  builder: (context, snapshot) {
                    if (snapshot.hasData) {
                      ...
                      final orgGroupList =
                          currentUserNotifier.currentUserData['OrgGroups'];
